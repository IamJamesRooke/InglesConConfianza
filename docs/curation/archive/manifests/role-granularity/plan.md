...
| P3-10 | Homeless extended rows | Sonnet | **done** — 13 degree modifiers / question frames / habitual (bastante/medio [adj], gran [sust], soler, ¿cuándo/dónde…?) extended→core; 55 everyday time/frequency adverbs + common noun senses extended→common. |
