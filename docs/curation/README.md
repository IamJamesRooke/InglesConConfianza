...
| 2026-09-05 | **Phrasal verb project, Phase 3** — backfilled `particle:` to 100% coverage across the 590-row union (213 rows tagged); found and untagged 31 more mistagged rows in the process (English absorbed the Spanish preposition's meaning into a plain transitive verb, or the match was really a full-infinitive complement); backfilled `en:` root tags to complete coverage (66 rows, mostly `en:be` on copula idioms) | `d181ac10`, `9202e9cc` | `curation-2026-09-05-phrasal-particle-backfill.tsv`, `curation-2026-09-05-phrasal-mistagged-untag.tsv`, `curation-2026-09-05-phrasal-root-{be,misc}-backfill.tsv` |
