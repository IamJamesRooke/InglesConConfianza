...
- The near-term success criterion is complete coverage of **Core Functional Language**, not perfect population of the entire curriculum database. Core is an elite, highly selective tier and every Core recommendation needs an explicit functional-necessity justification. Supporting is also selective: reserve it for extremely useful, broadly reusable language. Put non-everyday, situational, secondary, or readily inferable material in Reference unless it should be deleted altogether. Supporting and Reference classifications can remain provisional until Core coverage is secure.
