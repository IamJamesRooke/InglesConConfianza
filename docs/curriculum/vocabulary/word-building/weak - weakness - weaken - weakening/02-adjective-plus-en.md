...
The suffix **-en** can turn certain short descriptions into verbs meaning “become or make more like the description.”

| Description | Verb | Spanish |
|---|---|---|
| **weak** | **weaken** | debilitar(se) |
| **short** | **shorten** | acortar(se) |
