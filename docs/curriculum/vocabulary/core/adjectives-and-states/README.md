# Core Adjectives and States

This area contains the small adjective vocabulary reused throughout structural examples.
...
- [Core Vocabulary](core-vocabulary/README.md)
