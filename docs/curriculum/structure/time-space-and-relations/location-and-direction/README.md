...
| Area | Core example |
|---|---|
| general location | **Where is it? It's here.** |
| destination and origin | **to the office / from the office** |
| point, area, and surface | **at / in / on** |
| distance | **near / far from** |
| relative position | **next to / between / behind** |
