---
id: es-poder-future-ability--en-will-be-able-to-concept
...
Every entry in `mappings` is an independently trackable translation edge. They share the **future-indicative** family so exposure can roll up from the individual form to **poder** without combining this meaning with a different one.
