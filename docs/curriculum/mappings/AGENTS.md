...
- Phase 5C Pass 4 moved ordinary core and incidental vocabulary out of mappings without filtering its teaching content. Keep **trabajar** as a top-level mapping because its English particle and complement patterns support phrasal-verb instruction. Keep **direccion** and **dirigir** independent unless the owner makes a later decision.
