...
- Phase 5C Pass 9 moved the false-cognate-led **sonar / SONAR / soñar** source set into cognate transformations and moved **casi, comprar, junto, morir, nuevo, pagar**, and **vender** into core vocabulary. Their useful reverse distinctions remain owned by the qualifying English mapping hubs; preserve the complete Spanish source sets outside mappings.
- Phase 5C Pass 10 moved the cognate-led **cumplir / comply** source set into cognate transformations and moved **aguantar, caber, cerrar, cobrar, coger, correr**, and **jugar** into core vocabulary. Their useful English distinctions remain available as teaching material without requiring independent Spanish mapping hubs.
- Phase 5C Pass 11 moved **aprovechar, arreglar, averiguar, avisar, bajar, cambiar, cargar / encargar, cuidar, encontrar, gastar, guardar, llave, meter, mostrar, olvidar, pegar, romper**, and **subir / levantar** into core vocabulary, and moved **apuntar** and **tirar** into supplemental vocabulary. Preserve these complete source sets outside mappings; their ordinary lexical breadth does not require independent Spanish mapping hubs.
