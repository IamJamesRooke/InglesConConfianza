...
3. Keep the optional learner instruction visible above the sentence pairs. Pair-specific context hints and accepted alternatives remain readable beside their owners and stay out of accelerated pair navigation. Sentence-level helper and after-correct controls are retired; teachers use a following explanation slide for a custom follow-up message.
