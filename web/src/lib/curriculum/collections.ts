...
export const COLLECTION_FACETS: Record<CollectionFacet, string> = {
  ...
  audit: "full-database-audit state (docs/curation/archive/full-audit-plan.md) — reviewed marks a concept as judged at least once for role/membership/tags/examples; flagged marks a concept with an open question for the user, noted in full-audit-findings.md",
};
...
export const KNOWN_GRAMMAR_VALUES: ReadonlySet<string> = new Set([
  ...
  "indef-pronoun-person", "indef-pronoun-place", "indef-pronoun-quantity", "indef-pronoun-thing",
  ...
  "origin", "passive", "past-form-for-distance",
  ...
  "precaution", "prep-pronoun-a", "prep-pronoun-con", "prep-pronoun-para",
  "preposition-stranding", "prepositional-pronoun", "present-wish",
