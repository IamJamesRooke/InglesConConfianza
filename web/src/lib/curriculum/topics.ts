...
export const CURRICULUM_TOPICS: CurriculumTopic[] = [
  ...
  },
  {
    ...
    facetButtons: [
      ...
      {
        collection: "topic:people-family-rel",
        label: "People — Family & Relationships",
        family: "Meaning & context",
      },
      {
      ...
      },
      {
        ...
        label: "Objects — Money & Business",
        family: "Meaning & context",
      },
      {
        collection: "topic:objects-communication-media",
        label: "Objects — Communication & Media",
        family: "Meaning & context",
      },
      {
        collection: "topic:objects-physical",
        label: "Objects — Physical Items",
        family: "Meaning & context",
      },
      {
        collection: "topic:objects-misc-language",
        label: "Objects — Misc & Language",
        family: "Meaning & context",
      },
      {
      ...
      },
      {
        ...
        label: "Places — Home & Buildings",
        family: "Meaning & context",
      },
      {
        collection: "topic:places-public-city",
        label: "Places — Public & City",
        family: "Meaning & context",
      },
      {
  ...
  },
  {
    ...
    facetButtons: [
      ...
      {
        collection: "topic:adj-abs-oso-osa",
        label: "Abstract quality — -oso/-osa",
        family: "Meaning & context",
      },
      {
        collection: "topic:adj-abs-ico-ica",
        label: "Abstract quality — -ico/-ica",
        family: "Meaning & context",
      },
      {
        collection: "topic:adj-abs-ivo-iva",
        label: "Abstract quality — -ivo/-iva",
        family: "Meaning & context",
      },
      {
        collection: "topic:adj-abs-able",
        label: "Abstract quality — -able",
        family: "Meaning & context",
      },
      {
        collection: "topic:adj-abs-ible",
        label: "Abstract quality — -ible",
        family: "Meaning & context",
      },
      {
        collection: "topic:adj-abs-ente",
        label: "Abstract quality — -ente",
        family: "Meaning & context",
      },
      {
        collection: "topic:adj-abs-al",
        label: "Abstract quality — -al",
        family: "Meaning & context",
      },
      {
        collection: "topic:adj-abs-general",
        label: "Abstract quality — General",
        family: "Meaning & context",
      },
      {
