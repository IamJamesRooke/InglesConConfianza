...
export const questionsNegationTopic: CurriculumTopic = {
  ...
  // 2026-09-16: the do-support, inversion and emphatic groups were retired when their
  // conjugated frame rows folded into infinitive rows (question/negation are lesson rules).
  facetButtons: [
    {
